...
if(isset($_POST['submit']))
{
    ...
    else if($_POST["captcha"] == $_SESSION["code"]) 
    {
		...
		$query = "INSERT INTO daftar (id,S_id,S_nama1,S_nama2,S_nama3,S_ic1,S_ic2,S_ic3,S_alamat1,S_alamat2,S_alamat3,S_alamat4,S_phone1,
						S_phone2,S_posisi,S_jawatangred,S_username,S_email,S_password,S_status) VALUES
						('','$S_id','$S_nama1','$S_nama2','$S_nama3','$S_ic1','$S_ic2','$S_ic3','$S_alamat1','$S_alamat2','$S_alamat3','$S_alamat4','$S_phone1','$S_phone2',
						'$S_posisi','$S_jawatangred','$S_username','$S_email','$S_password','$S_status')";
...
<form action="" name="print" method="POST" id="print" enctype="multipart/form-data" >
<div class='form_box'>
